...
public class FollowerList extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    private final String TAG="FollowerList";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.follower_list_layout,container,false);
        mRecyclerView=(RecyclerView)view.findViewById(R.id.follower_list_rec);
        mToolbar=(Toolbar)view.findViewById(R.id.follower_list_toolbar);
        mProgressBar=(ProgressBar)view.findViewById(R.id.follower_list_progressBar);

        mToolbar.setTitle("follower list");
        ...
        mSwipeRefreshLayout=(SwipeRefreshLayout)view.findViewById(R.id.follower_list_swipe);
    ...
    private void getFollowerUsers() {
        ...
        if (mLastQueriedDocument!=null){
            ref =FirebaseFirestore.getInstance()
                    ...
                    .whereEqualTo("followed_id",mUserId).orderBy("timeStamp",Query.Direction.DESCENDING)
                    .startAfter(mLastQueriedDocument);

        }else {
            ref =FirebaseFirestore.getInstance().collection("followings").whereEqualTo("followed_id",mUserId);
        }
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    for (DocumentSnapshot snapshot:task.getResult()){
                        ...
                        DocumentReference ref1=FirebaseFirestore.getInstance().collection("users").document(obj.getFollower_id());
